...
@RestController
@RequestMapping/*Indica o caminho até o request*/("/v1/senac")
public class AlunoController {

    @Autowired
    private AlunoService alunoService;

    @GetMapping/*Indica o caminho até o método get*/(value = "/aluno", produces = MediaType.APPLICATION_JSON_VALUE)
